...
p[[4]][["labels"]][["title"]] <- paste0("Cluster 4 - 1460 genes")
p[[5]][["labels"]][["title"]] <- paste0("Cluster 5 - 1789 genes")
p[[6]][["labels"]][["title"]] <- paste0("Cluster 6 - 650 genes")
```
...
cluster_1_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_1_genes, ]

cluster_1_effector_filtered <- cluster_1_effector %>%
  filter(PHI_homology == 1 | effectorP == 1)

cluster_2_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_2_genes, ]

cluster_2_effector_filtered <- cluster_2_effector %>%
  filter(PHI_homology == 1 | effectorP == 1)

cluster_3_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_3_genes, ]

cluster_3_effector_filtered <- cluster_3_effector %>%
  filter(PHI_homology == 1 | effectorP == 1)

cluster_4_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_4_genes, ]

cluster_4_effector_filtered <- cluster_4_effector %>%
  filter(PHI_homology == 1 | effectorP == 1)

cluster_5_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_5_genes, ]

cluster_5_effector_filtered <- cluster_5_effector %>%
  filter(PHI_homology == 1 | effectorP == 1) 

cluster_6_effector <- Cluster_labels[Cluster_labels$gene_id %in% cluster_6_genes, ]

cluster_6_effector_filtered <- cluster_6_effector %>%
  filter(PHI_homology == 1 | effectorP == 1)
```
