...
resSD<-mitch_calc(y,genesets,priority="SD", minsetsize = 5, cores=2, resrows = 60)
```
...
#png(filename = "../Figures/Mitchsig.png", width = 6400, height = 6400, res = 600)
...
#png(filename = "../Figures/Mitch_effect.png", width = 6400, height = 6400, res = 600)
...
#png(filename = "../Figures/MitchSD.png", width = 6400, height = 6400, res = 600)
...
#mitch_report(resSD,"PcSDreport3.html")
...
#mitch_plots(resSD,outfile="Pccharts3.pdf")
```
