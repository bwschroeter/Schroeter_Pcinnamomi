...
png(filename = "Early_pheatmap-scaledl2fc.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
earlygenesDE <- head(top_gene_expression_early.id[order(top_gene_expression_early.id$pvalue), ], 10)
earlygenesDE <- earlygenesDE$gene_id
...
png(filename = "EarlyDEvolcano.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
```{r}
knitr::include_graphics("../PcDESeq2/Early_pheatmap-scaledl2fc.png")
top_gene_expression_early.id %>% kbl(caption="Top 50 Genes by p-value (Late)") %>%   kable_paper("hover", full_width = T)
knitr::include_graphics("../PcDESeq2/EarlyDEvolcano.png")
```
...
top_gene_expression_mid.id <- dplyr::right_join(pc.annotations, top_gene_expression_mid.id, by = 'gene_id') %>%
  arrange(padj)
...
png(filename = "Mid_pheatmap-scaledl2fc.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
png(filename = "MidDEvolcano.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
```{r}
knitr::include_graphics("../PcDESeq2/Mid_pheatmap-scaledl2fc.png")
top_gene_expression_early.id %>% kbl(caption="Top 50 Genes by p-value (Late)") %>%   kable_paper("hover", full_width = F)
knitr::include_graphics("../PcDESeq2/MidDEvolcano.png")
```
...
top_gene_expression_late.id <- dplyr::right_join(pc.annotations, top_gene_expression_late.id, by = 'gene_id') %>%
  arrange(padj)
...
png(filename = "Late_pheatmap-scaledl2fc.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
png(filename = "LateDEvolcano.png", width = 4800, height = 4800, pointsize = 10, res = 600)
...
```{r}
knitr::include_graphics("../PcDESeq2/Late_pheatmap-scaledl2fc.png")
top_gene_expression_late.id %>% kbl(caption="Top 50 Genes by p-value (Late)") %>%   kable_paper("hover", full_width = T)
knitr::include_graphics("../PcDESeq2/LateDEvolcano.png")
```
