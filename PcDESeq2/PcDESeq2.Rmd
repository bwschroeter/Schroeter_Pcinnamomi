...
```
```{r}
knitr::include_graphics("../Figures/PCA_vst.png")
```
...
```{r}
knitr::include_graphics("../Figures/Mid_pheatmap-scaledl2fc.png")
#top_gene_expression_early.id %>% kbl(caption="Top 50 Genes by p-value (Late)") %>%   kable_paper("hover", full_width = F)
knitr::include_graphics("../Figures/MidDEvolcano.png")
```
...
```{r}
knitr::include_graphics("../Figures/Late_pheatmap-scaledl2fc.png")
#top_gene_expression_late.id %>% kbl(caption="Top 50 Genes by p-value (Late)") %>%   kable_paper("hover", full_width = T)
knitr::include_graphics("../Figures/LateDEvolcano.png")
```
