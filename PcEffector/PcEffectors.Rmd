...
write.csv(gtf.omicsbox.effector, file = "/mnt/data/barry/projects/Schroeter_Pcinnamomi/shared_scripts/effectortable.tsv", row.names = FALSE)
...
png("RxLR_normalized.png", width = 6400, height = 6400, pointsize = 10, res = 600)

rxlrphm <- pheatmap(rxlr.de,  scale = "row",
...
filename <- 
png("RxLR_Log2Fold.png", width = 6400, height = 6400, pointsize = 10, res = 600)
...
png("CRN_normalized.png", width = 6400, height = 6400, pointsize = 10, res = 600)

crnpmh <- pheatmap(crn.de,  scale = "row",
         cluster_rows = TRUE, cluster_cols = F,
         display_numbers = F, 
         fontsize_row = 8, fontsize_col = 8, 
         annotation_col = col_ann,
...
png("CRN_Log2Fold.png", width = 6400, height = 6400, pointsize = 10, res = 600)
...
png("NLP_mormalized.png", width = 6400, height = 6400, pointsize = 10, res = 600)

nlpphm <- pheatmap(nlp.de,  scale = "row",
         cluster_rows = TRUE, cluster_cols = F,
         display_numbers = F, 
         fontsize_row = 8, fontsize_col = 8, 
         annotation_col = col_ann,
...
png("NLP_Log2Fold.png",  width = 6400, height = 6400, pointsize = 10, res = 600)
...
png("Elicitin_Log2Fold.png", width = 6400, height = 6400, pointsize = 10, res = 600)
