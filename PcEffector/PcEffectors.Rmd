...
allsecreted <- c(nlp.df$protein_id, crn.df$protein_id, rxlr.df$protein_id, detectedeffectors$protein_id)


output_file <- "/mnt/data/barry/projects/Schroeter_Pcinnamomi/PcEffector/allSP.fasta"

generate_fasta_file(SPdf, output_file)
...
#save(detectedeffectors, effectorp.results.id, file = "secrete.effect.RData")
