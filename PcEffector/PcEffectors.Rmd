...
```{r}
signal <- grepl("signal", interproscanresults$signature_id, ignore.case = TRUE)

interproscanresults[signal, ]
#extract signal peptides from interproscan res
signalprotein <- unique(interproscanresults[interproscanresults$signature_id == "SIGNAL_PEPTIDE", "protein_id" ])
